...
image_path = 'ObjectDetection/DiningTable.jpeg'
prototxt_path = 'ObjectDetection/models/MobileNetSSD_deploy.prototxt'
model_path = 'ObjectDetection/models/MobileNetSSD_deploy.caffemodel'
